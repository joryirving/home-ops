...
locals {
  applications = {
    ...
    open-webui = {
      client_id     = module.onepassword_application["open-webui"].fields["OPEN-WEBUI_CLIENT_ID"]
      client_secret = module.onepassword_application["open-webui"].fields["OPEN-WEBUI_CLIENT_SECRET"]
      group         = "home"
      icon_url      = "https://raw.githubusercontent.com/open-webui/blob/main/static/favicon.png"
